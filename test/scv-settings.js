(typeof describe === 'function') && describe("scv-settings", function() {
        ...
        constructor() {
            ...
            Object.defineProperty(this, 'set', {
                get() { return (cookie, value) => {
                    this[cookie] = JSON.stringify(value);
                }},
            });
    ...
    */
    ...
    it("TESTTEST$cookie is mock", ()=>{
        let now = new Date();
        let cookie = {now};
        $cookie.set('test-cookie', cookie);
        let json = $cookie.get('test-cookie');
        should.deepEqual(JSON.parse(json), JSON.parse(JSON.stringify(cookie)));
