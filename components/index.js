...
export { default as ScvArticle } from './scv-article.vue';
export { default as ScvArticleItems } from './scv-article-items.vue';
...
export { default as ScvTipitaka } from './scv-tipitaka.vue';
